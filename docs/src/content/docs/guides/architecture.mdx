...
title: Architecture
description: >-
  Recommended foundation — Pure Core (side-effect-free domain logic) inside an
  Imperative Shell (HTTP, DB, I/O), aligned with CQRS and Event Sourcing.
---
EventFabric tries to not be too opinionated and does not enforce a specific architecture or design pattern.
...
![Illustration of the pure core imperative shell architecture](../../../assets/pure-core-imperative-shell.svg)
...
![Illustration of the flow of information](../../../assets/flow-of-information.svg)
