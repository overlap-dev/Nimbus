...
title: Events
description: >-
  Events are immutable CloudEvents facts about what already happened; they power
  event-driven and event-sourced designs.
---
...
Events are published and subscribed to using the [EventBus](/core/event-bus). See the EventBus documentation for details on publishing and subscribing to events.
