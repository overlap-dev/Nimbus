...
const features = [
    {
        icon: { src: '/simplecore.png', alt: 'Icon for Simple Core Concepts', width: '48px', height: '48px' },
    ...
    {
        icon: { src: '/cqrs.png', alt: 'Icon for CQRS', width: '48px', height: '48px' },
    ...
    {
        icon: { src: '/eventsourcingdb.png', alt: 'Icon for EventSourcingDB', width: '48px', height: '48px' },
        title: 'Event Sourcing',
        details: 'When building your application to reflect real world actions and events it is crucial to store those events properly.<br><br>Nimbus integrates seamlessly with <a href="https://www.eventsourcingdb.io/" target="_blank" rel="noopener noreferrer">EventSourcingDB</a>.',
    },
    {
        icon: { src: '/opentelemetry.png', alt: 'Icon for OpenTelemetry', width: '48px', height: '48px' },
